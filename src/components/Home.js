        ...
        <Grid container spacing={2} p={2} sx={{ justifyContent: 'center', alignItems: 'center', height: '100vh', paddingBottom: 10 }}>
            <Grid item xs={12} md={10} lg={4} sx={{  display: { xs: 'none', sm: 'block'} }}>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    <Link href="https://github.com/Cozhee" mr={1}>
                            <BsGithub size={35} style={{ color: '#24292e' }}/>
                    </Link>
                    <Link href="https://www.linkedin.com/in/davis-r-cody/" mr={1}>
                            <BsLinkedin size={35} style={{ color: '#0b65c2' }}/>
                    </Link>
